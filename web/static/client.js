...
/***/ function(module, exports, __webpack_require__) {
	...
	var rtc = __webpack_require__(92);

	var filesharing = d3.select('.filesharing');

	if (!filesharing.empty()) {
	  var signals;
	  var handler;
	  var parts;

	  (function () {
	    var signal = function signal(sig) {
	      parts.push(sig);
